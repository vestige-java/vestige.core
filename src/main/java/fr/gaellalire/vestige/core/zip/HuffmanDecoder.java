...
import static fr.gaellalire.vestige.core.zip.HuffmanState.DYNAMIC_CODES;
import static fr.gaellalire.vestige.core.zip.HuffmanState.FIXED_CODES;
import static fr.gaellalire.vestige.core.zip.HuffmanState.INITIAL;
import static fr.gaellalire.vestige.core.zip.HuffmanState.STORED;
...
class HuffmanDecoder implements Closeable {
     ...
     */
    private static final short[] RUN_LENGTH_TABLE = {96, 128, 160, 192, 224, 256, 288, 320, 353, 417, 481, 545, 610, 738, 866, 994, 1123, 1379, 1635, 1891, 2148, 2660, 3172, 3684,
            4197, 5221, 6245, 7269, 112};
