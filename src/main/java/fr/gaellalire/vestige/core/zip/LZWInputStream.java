...
/**
 * <p>
 * Generic LZW implementation. It is used internally for the Z decompressor and the Unshrinking Zip file compression method, but may be useful for third-party projects in
 * implementing their own LZW variations.
 * </p>
 * @NotThreadSafe
 * @since 1.10
 */
