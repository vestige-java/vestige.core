...
/**
 * This interface provides statistics on the current decompression stream. The stream consumer can use that statistics to handle abnormal compression ratios, i.e. to prevent zip
 * bombs.
 * @since 1.17
 */
