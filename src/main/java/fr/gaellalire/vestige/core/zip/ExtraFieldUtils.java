...
public class ExtraFieldUtils {
     ...
     * <p>
     * Calls {@link ZipExtraField#parseFromCentralDirectoryData} or {@link ZipExtraField#parseFromLocalFileData} internally and wraps any {@link ArrayIndexOutOfBoundsException}
     * thrown into a {@link ZipException}.
     * </p>
     ...
     * @param local whether the extra field data stems from the local file header. If this is false then the data is part if the central directory header extra data.
        ...
        public ZipExtraField onUnparseableExtraField(final byte[] data, final int off, final int len, final boolean local, final int claimedLength) throws ZipException {
            ...
            case THROW_KEY:
                throw new ZipException(
                        "Bad extra field starting at " + off + ".  Block length of " + claimedLength + " bytes exceeds remaining" + " data of " + (len - WORD) + " bytes.");
            case READ_KEY:
