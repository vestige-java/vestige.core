...
public class BZip2CompressorInputStream extends CompressorInputStream implements BZip2Constants, InputStreamStatistics {
     ...
     * @param in the InputStream from which this object should be created
     * @param decompressConcatenated if true, decompress until the end of the input; if false, stop after the first .bz2 stream and leave the input position to point to the next
    ...
    private static final class Data {
        ...
        /**
         * Initializes the {@link #tt} array. This method is called when the required length of the array is known. I don't initialize it at construction time to avoid unneccessary
