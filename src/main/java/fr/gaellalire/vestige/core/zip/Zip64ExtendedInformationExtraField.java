...
public class Zip64ExtendedInformationExtraField implements ZipExtraField {
     ...
     * @throws IllegalArgumentException if size or compressedSize is null
     */
    public Zip64ExtendedInformationExtraField(final ZipEightByteInteger size, final ZipEightByteInteger compressedSize, final ZipEightByteInteger relativeHeaderOffset,
     ...
     * <p>
     * All four fields inside the zip64 extended information extra field are optional and must only be present if their corresponding entry inside the central directory contains
     ...
     */
    public void reparseCentralDirectoryData(final boolean hasUncompressedSize, final boolean hasCompressedSize, final boolean hasRelativeHeaderOffset, final boolean hasDiskStart)
            throws ZipException {
