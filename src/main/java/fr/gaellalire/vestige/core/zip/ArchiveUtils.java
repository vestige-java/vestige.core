...
public class ArchiveUtils {
    ...
    /**
     * Returns a "sanitized" version of the string given as arguments, where sanitized means non-printable characters have been replaced with a question mark and the outcome is not
     * longer than 255 chars.
     * <p>
     * This method is used to clean up file names when they are used in exception messages as they may end up in log files or as console output and may have been read from a
     * corrupted input.
     * </p>
